...
let style = { font: '18px Cabin', fill: 'black', align: 'left', wordWrap: {width: 300, useAdvancedWrap: true} };
...
class DialogueCutscene extends Phaser.Scene {
    ...
    renderCutscene(dialogueContainer) {
        ...
        console.log(this.responses, "this is my this.responses")
        ...
        this.title = this.add.text(550, 80, dialogue.name, { font: "40px Berkshire Swash", fill: 'black'});
